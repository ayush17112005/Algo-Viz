...
// const generateRandomArray = (size = DEFAULT_ARRAY_SIZE) => {
...
//   // Handle array change effect
//   useEffect(() => {
//     if (steps.length > 0) {
//       setSteps(algorithm.generateSteps(array));
//       setCurrentStep(0);
//     }
...
//   // Current step data - now algorithm-agnostic
...
//       partitioning: [],
//       pivot: null,
//       // Add any other algorithm-specific states here
//     },
...
// src/hooks/useSortingAnimation.js
import { useState, useEffect, useCallback } from "react";
